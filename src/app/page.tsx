...
import { convertMDXToArticle, getMDXs, sortArticles } from './_lib/utils/server/utils';
...
export default async function Home() {
  ...
  const sorted = sortArticles(articles.articles, mdxConverted);

  const response = {
    articles: sorted,
    page: articles.page,
    totalPage: Math.max(articles.totalPage, mdxs.hasNext ? 2 : 1),
  };
  return (
